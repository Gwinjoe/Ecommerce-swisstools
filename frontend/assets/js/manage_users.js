  ...
  data.forEach(user => {
    ...
    row.innerHTML = `
            ...
            <td>
                ...
                <button class="action-btn" data-action="delete" data-id="${user._id}" id="delete-button" aria-label="Delete User"><i class="fas fa-trash-alt"></i></button>
            </td>
        `;
...
window.openModal = function(mode, id = null) {
  ...
  const statusInput = document.getElementById("admin");
